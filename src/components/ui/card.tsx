...
export function Card(props: React.PropsWithChildren<{className?:string; style?:React.CSSProperties;}>) {
  return <div className={`card ${props.className||""}`} style={props.style}>{props.children}</div>;
}
...
export function CardDescription(props: React.PropsWithChildren<{className?:string; style?:React.CSSProperties;}>) {
  return <p className={props.className||""} style={props.style}>{props.children}</p>;
}
